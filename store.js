function Book(data) {
    this.bookShelf = data.volumeInfo.categories ? data.volumeInfo.categories.join(', ') : 'N/A';
    ...
    this.image = data.volumeInfo.imageLinks ? getSecureUrl(data.volumeInfo.imageLinks.thumbnail) : 'https://i.imgur.com/J5LVHEL.jpg';
